  ...
  const recommendProduct = hourlyEnergyRequired => {
    ...
    switch (true) {
      case hourlyEnergyRequired < 1000:
        offer = "Soltera 1kwh Flexible Monocrystalline Solar Panels";
        console.log("I am here 1");
        break;
      case hourlyEnergyRequired < 5000:
        offer = "Soltera 2-5kwh Foldable Solar Panels";
        break;
      case hourlyEnergyRequired < 7000:
        offer = "Soltera 7kwh Polycrystalline High Efficient Solar Panels";
        break;
      case hourlyEnergyRequired < 10000:
        offer = "Soltera 10kwh Polycrystalline Solar Panels";
        break;
      default:
        offer = "Soltera Industrial Workhorse Polycrystalline Solar Panels";
    }
    return offer;
  };
